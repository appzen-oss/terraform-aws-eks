locals {
  ...
  workers_group_defaults_defaults = {
    ...
    iam_role_id                   = var.existing_instance_iam_profile_arn != "" ? var.existing_instance_iam_profile_arn : local.default_iam_role_id  # A custom IAM role id. Incompatible with iam_instance_profile_name.  Literal local.default_iam_role_id will never be used but if iam_role_id is not set, the local.default_iam_role_id interpolation will be used.
